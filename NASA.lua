...
{
{text = 'رفع مطور✅',type = 'text'},{text = '❌تنزيل مطور',type = 'text'}
},
{
{text = '🔚 | القائمه الرئيسيه',type = 'text'},
},
...
local news =[[
    ...
    𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐌𝐀𝐊𝐄𝐑 𝐏𝐑𝐎𝐓𝐄𝐂𝐓𝐈𝐎𝐍 𝐕𝐄𝐍𝐎𝐌
...
🇪🇬 𝐷𝐸𝑉 >> [˹ 𝐑𝐀𝐆𝐀𝐁.](https://t.me/RG_AB)

ــــــــــــــــــــــــــــــــــــــــــــــ  

🇪🇬ـ>> [˹ 𝙎𝙊𝙐𝙍𝘾𝙀 𝘾𝙃𝘼𝙉𝙉𝙀𝙇.](https://t.me/RB_RO) 
...
{
{text = '🔹 | طريقه عمل بوت',type = 'text'},{text = '✅ | تواصل مع المبرمج ', url = 't.me/r_n_b1'}, 
},
{
...
if text and text:match("/venom st(.*)u(%d+)") then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text = '- اخفاء الامر ', data =msg.sender_id.user_id..'/delAmr'},},}}
 send(msg.chat_id,msg.id,"https://telegra.ph/file/4cda4eefc84190c0929ab.mp4","html",false, false, false, false, reply_markup)
end
----end making user
if text == "❎ | حذف بوت" then
if Redis:get(NASA..msg.sender_id.user_id.."my:bot") then
